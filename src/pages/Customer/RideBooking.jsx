...
// --- Leaflet Map Components (UNCHANGED) ---
...
  // ***************************************************************
  // * CORRECTED FUNCTION: This now returns NULL instead of coordinates on failure. *
  // ***************************************************************
...
      return null; // <--- CHANGE IS HERE: Return null to trigger the manual error in useCurrentLocationForPickup
    }
  };
...
        } else {
          // * This error message will now be used if reverseGeocode fails *
